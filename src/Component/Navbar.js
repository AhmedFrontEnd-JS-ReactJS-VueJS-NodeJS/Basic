  ...
  return (
    <div className='flex'>
      <div className='flex flex-col bg-white w-60 relative shadow-xl columns-4'>
        ...
        <div className='mt-6 flex justify-center absolute top-[840px] left-9 text-white font-semibold text-xl'>
          <a className='py-3 px-12 bg-green-600 rounded-md ' href='to'>log-Out</a>
        </div>
        <p className='text-center absolute top-[930px] left-16 '>Help desk <br />786-874 9988</p>
